...
void dobInit(ControlParams *controlParams, FirstOrderLowPassFilterParams *firstOrderLowPassFilterParams, SecondOrderLowPassFilterParams *secondOrderLowPassFilterParams, PreviousVariables *previousVariables, Rdda *rdda) {
    ...
    for (int i = 0; i < 2; i ++) {
        previousVariables->pos_tar[i] = rdda->motor[i].rosIn.pos_ref;
        previousVariables->prev_pos_tar[i] = rdda->motor[i].rosIn.pos_ref;
        previousVariables->filtered_pos_tar[i] = rdda->motor[i].rosIn.pos_ref;
        previousVariables->prev_filtered_pos_tar[i] = rdda->motor[i].rosIn.pos_ref;
        previousVariables->stiffness[i] = rdda->motor[i].rosIn.stiffness;
        previousVariables->prev_stiffness[i] = rdda->motor[i].rosIn.stiffness;
        previousVariables->filtered_stiffness[i] = rdda->motor[i].rosIn.stiffness;
        previousVariables->prev_filtered_stiffness[i] = rdda->motor[i].rosIn.stiffness;
        previousVariables->vel_sat[i] = rdda->motor[i].rosIn.vel_sat;
        previousVariables->prev_vel_sat[i] = rdda->motor[i].rosIn.vel_sat;
        previousVariables->filtered_vel_sat[i] = rdda->motor[i].rosIn.vel_sat;
        previousVariables->prev_filtered_vel_sat[i] = rdda->motor[i].rosIn.vel_sat;
        previousVariables->tau_sat[i] = rdda->motor[i].rosIn.tau_sat;
        previousVariables->prev_tau_sat[i] = rdda->motor[i].rosIn.tau_sat;
        previousVariables->filtered_tau_sat[i] = rdda->motor[i].rosIn.tau_sat;
        previousVariables->prev_filtered_tau_sat[i] = rdda->motor[i].rosIn.tau_sat;
        previousVariables->pos_ref[i] = rdda->motor[i].rosIn.pos_ref;
...
void dobController(Rdda *rdda, ControlParams *controlParams, FirstOrderLowPassFilterParams *firstOrderLowPassFilterParams, SecondOrderLowPassFilterParams *secondOrderLowPassFilterParams, PreviousVariables *previousVariables) {
    ...
    for (int i = 0; i < num; i ++) {
        pos_tar[i] = rdda->motor[i].rosIn.pos_ref;
        ...
        vel_sat[i] = rdda->motor[i].rosIn.vel_sat;
    ...
    /* Stiffness reading */
    for (int i = 0; i < num; i ++) {
        stiffness[i] = rdda->motor[i].rosIn.stiffness;
...
/*    for (int i = 0; i < num; i ++) {
    ...
    for (int i = 0; i < num; i ++) {
        tau_sat[i] = rdda->motor[i].rosIn.tau_sat;
