...
void rdda_update(ecat_slaves *ecatSlaves, Rdda *rdda) {
    ...
    double pre_pressure = 390000; // unit pascal
...
void initRddaStates(ecat_slaves *ecatSlaves, Rdda *rdda) {
    ...
    for (int i = 0; i < MOTOR_COUNT; i++) {
        ...
        rdda->motor[i].tau_sat = 2.0;
        rdda->motor[i].stiffness = 0.0;
        rdda->motor[i].rddaPacket.pos_in = 0.0;
        rdda->motor[i].rddaPacket.pos_d_in = 0.0;
        rdda->motor[i].rddaPacket.pos_d_out = 0.0;
        rdda->motor[i].rddaPacket.vel_in = 0.0;
        ...
        rdda->motor[i].rddaPacket.energy_tdpa_in = 0.0;
        rdda->motor[i].rddaPacket.energy_tdpa_out = 0.0;
    }
    rdda->freq_anti_alias = 500;
    rdda->ts.sec = rdda->ts.nsec = 0;
    rdda->error_signal.error_in = 0;
    rdda->ts.delay_cycle = 4;
}
